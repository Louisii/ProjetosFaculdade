...
public class Executavel {
	...
	public static void main(String[] args) {
		...
		//2-F
		emp.listarContatoPassageiro("Carlos");
		System.out.println("------------------\n");
		
		//2-G
		emp.listarPassageirosPorTrechoLinha("Paris-Londres");
		System.out.println("------------------\n");
		
		//2-H
		emp.identificarPassageiroPorPassaporte("FX-1111");
		System.out.println("------------------\n");
		
		//2-I
		LocalDateTime horario = emp.mostrarHorarioTremPorTrechoLinha("Paris-Londres");
		System.out.println("Horário do Trem: " + horario.format(DateTimeFormatter.ofPattern("HH:mm:ss")));
		System.out.println("------------------\n");
		
		//2-J
		double preco = emp.informarPrecoPassagemPorNumeroTrem(1250);
